 ...
 */
function isStateRegulationsSlug(slug: string): boolean {
  // Pattern: {stateCode}-state-regulations-small-business-requirements
  return slug.includes('-state-regulations-small-business-requirements');
}
